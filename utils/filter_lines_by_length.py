...
# ファイルパスの設定
input_file_path = 'egs2/librispeech/asr1/dump/raw/lm_train.txt'
output_file_path = f'egs2/librispeech/asr1/dump/raw/lm_train_filtered_{max_length}.txt'  # フィルタリングした後の元のテキストを記録する新しいファイル
